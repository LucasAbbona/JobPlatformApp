<x-layout>
    <div class="px-20 my-5">
        ...
        <a href="/profile/edit/{{$profile->id}}" class="shake-horizontal mt-20 flex justify-center rounded-lg py-5 hover:bg-blue-500 text-xl font-semibold text-white bg-blue-400">Edit Profile</a>
    </div>
</x-layout>